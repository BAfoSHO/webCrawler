...
```
cd existing_repo
git remote add origin https://research-git.uiowa.edu/banderson15/cs3640-a5.git
git branch -M main
...
- [ ] [Set up project integrations](https://research-git.uiowa.edu/banderson15/cs3640-a5/-/settings/integrations)
